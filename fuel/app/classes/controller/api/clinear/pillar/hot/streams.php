 ...
 * @extends Controller
 */
class Controller_API_cLinear_Pillar_Hot_Streams extends Controller_API
{
    ...
    public function get_comcast($count = null, $dateStart = null, $dateEnd = null)
    {
        ...
        $data = $metric->comcastAvailabilityRaw($count, $dateStart, $dateEnd);
    ...
    /**
     * Return api response with 100 worst streams at the pillar component for the date or date range given
     * /api/clinear/pillar/hot/streams/comcast/(/:count)?(/:start)?(/:end)?
     * @access public
     * @param  Int    $count number of worst hosts to provide, default 10
     * @param  String $date  Y-m-d formatted date of interest, default yesterday
    ...
    public function get_worst100($count = null, $dateStart = null, $dateEnd = null)
    {
        ...
        $dateStart  = $this->ingestDate($dateStart, 0);
        $dateEnd    = $this->ingestDate($dateEnd, 0);

        // Generate data from metric
        $metric = new Metric_VopsDataCube();
        $data = $metric->worst100Pillar($count, $dateStart, $dateEnd);
    ...
    public function get_cox()
    {
        ...
        return Response::forge(Presenter::forge('api/clinear/pillar/hot/streams/cox', 'view', NULL, 'api/response'), 200, array('Content-Type','application/json'));
    }
     ...
     * @return Response
     */
    public function get_coxworst($count = null, $dateStart = null, $dateEnd = null)
    {
        // Process parameters
        $count      = $this->ingestParameter($count, 10);
        $dateStart  = $this->ingestDate($dateStart, 0);
        ...
        $data = $metric->coxpillarworst10($count, $dateStart, $dateEnd);
