...
/**
 * The API NoStarted-Incidents presenter.
 *
 * @package app
 * @extends Presenter
 */
...
// use \Model\Validator;
class Presenter_API_cLinear_Incidents_Notstarted extends Presenter_API_cLinear_Template
{
    ...
    public function view()
    {
        ...
        $responseIncidents = $this->selectDataByDateRange(
            ...
            'missing_timestamp',                // DB Table Name (MySQL)
            'date_resolved',                    // DB Field Name for dates
        ...
        $this->response['data'] = $this->createArrayBucketsByField($responseIncidents['data'], 'date_resolved');
    }
