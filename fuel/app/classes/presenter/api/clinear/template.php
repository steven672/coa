...
// use \Model\Validator;
class Presenter_API_cLinear_Template extends Presenter_API_Template
{
    ...
    public function selectDataByDateRangeAndHot(
        ...
        $dbTable = null,
        // Required: The name of the table in the database that we're selecting data from
        $dbFieldHot,
        // Required: The field in the $dbTable that we'll sort on to get the hottest items (i.e. minutes impacted)
        $dbFieldDate = null,
        // Required: The column in the $dbTable that holds the date for each record
