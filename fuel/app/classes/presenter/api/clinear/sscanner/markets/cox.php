...
// use \Model\Validator;
class Presenter_API_cLinear_Sscanner_Markets_Cox extends Presenter_API_cLinear_Template
{
    ...
    public function view()
    {
        ...
        $responseWorst3Cox = $this->selectDataByDateRangeAndHot(
            'viper_watermark',                  // DB Connection Label (from app config)
            'Streamscannerw3',                  // DB Table Name (MySQL)
        ...
        $this->response['data'] = array(
                                   'responseWorst3Cox' => $this->createArrayBucketsByField($responseWorst3Cox['data'], 'date_created'),
                                  );
    }
