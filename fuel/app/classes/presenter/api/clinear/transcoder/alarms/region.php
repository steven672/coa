...
// use \Model\Validator;
class Presenter_API_cLinear_Transcoder_Alarms_Region extends Presenter_API_cLinear_Template
{
    ...
    public function view()
    {
        ...
        $responseIncidents = $this->selectDataByDateRangeAndSortExtraField(
            ...
            'transcoder_region_alarms',                          // DB Table Name (MySQL)
            'alarmNum', // DB extra field to be sorted
