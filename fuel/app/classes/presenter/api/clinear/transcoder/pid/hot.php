...
// use \Model\Validator;
class Presenter_API_cLinear_Transcoder_Pid_Hot extends Presenter_API_cLinear_Template
{
    ...
    public function view()
    {
        ...
        $responseTranscoderHotPid10 = $this->selectDataByDateRangeAndHot(
            'viper_clinear_new',                 // DB Connection Label (from app config)
            'transcoder_pid_worst10',     // DB Table Name (MySQL)
        ...
        $this->response['data'] = array(
                                   'responseTranscoderHotPid10' => $this->createArrayBucketsByField(
                                       $responseTranscoderHotPid10['data'],
                                       'date_created'
                                   ),
                                  );
    }
