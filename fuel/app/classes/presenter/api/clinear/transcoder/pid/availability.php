...
// use \Model\Validator;
class Presenter_API_cLinear_Transcoder_Pid_Availability extends Presenter_API_cLinear_Template
{
    ...
    public function view()
    {
        /*
            ...
            * Valid URL calls:
            *   api/clinear/transcoder/alarms/region/2017-01-01/2017-01-10         From January 1, 2017 to January 10, 2017 in all Transcoder  alarms  per region  data (YYYY-MM-DD)
         */
        ...
        $responseIncidents = $this->selectDataByDateRangeAndSortExtraField(
            ...
            'transcoder_pid_error',             // DB Table Name (MySQL)
            'successRate',                      // DB extra field to be sorted
