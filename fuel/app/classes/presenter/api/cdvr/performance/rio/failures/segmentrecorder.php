...
class Presenter_API_cDVR_Performance_Rio_Failures_SegmentRecorder extends Presenter_API_cDVR_Template
{
    ...
    public function view()
    {
        ...
        $responseRio = $this->selectDataByDateRangeAndRegion(
            ...
            'RioRecordingFailuresByMarket@SegmentRecorder',         // DB Table Name (MySQL)
