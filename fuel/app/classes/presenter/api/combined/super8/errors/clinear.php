...
// use \Model\Validator;
class Presenter_API_Combined_Super8_Errors_cLinear extends Presenter_API_Combined_Template
{
    ...
    public function view()
    {
        /*
            ...
            * Valid URL calls:
            *   /api/combined/super8/errors/cLinear/2017-04-04/2017-04-05         From April 04, 2017 to April 05, 2017 in all cLinear  deliver_Lane counts data (YYYY-MM-DD)
            */
    ...
    )
    {
        ...
        //echo DB::last_query();
         $queryBuilderObject->and_where('Delivery_Lane','like','cLinear');
