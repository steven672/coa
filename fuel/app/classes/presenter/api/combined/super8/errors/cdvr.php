...
// use \Model\Validator;
class Presenter_API_Combined_Super8_Errors_cDVR extends Presenter_API_Combined_Template
{
    ...
    public function view()
    {
        /*
            ...
            * Valid URL calls:
            *   /api/combined/super8/errors/cdvr/2017-04-04/2017-04-05         From April 04, 2017 to April 05, 2017 in all cdvr  deliver_Lane counts data (YYYY-MM-DD)
            */
    ...
    )
    {
        ...
        if (is_null($queryBuilderObject = $this->queryWhereDateOrRange($queryBuilderObject, $dbFieldDate = 'date_created', $dateProvidedStart, $dateProvidedEnd))) return NULL;
         ...
         $queryBuilderObject->and_where('Delivery_Lane','=','cDVR');
